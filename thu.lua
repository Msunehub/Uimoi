...
UICornerFrame.Parent = TabFrame
        ...
        function Update:Notification(textdesc)
            ...
            OkayBtnTitle.TextColor3 = Color3.fromRGB(34, 34, 34)
        ...
        function main:Button(text, callback)
            ...
            TextBtn.Text = text
            TextBtn.TextColor3 = Color3.fromRGB(34, 34, 34)
            ...
            Black.Name = "Black"
            Black.Parent = Button
            Black.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
...
CheckFrame2.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
...
Title.TextXAlignment = Enum.TextXAlignment.Left
        ...
        function main:Dropdown(text, option, callback)
            ...
            DropButton.Text = ""
            DropButton.TextColor3 = Color3.fromRGB(34, 34, 34)
        ...
        function main:Slider(text, min, max, start, callback)
            ...
            SliderFrame_2.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
...
AHEHE.Text = ""
AHEHE.TextColor3 = Color3.fromRGB(34, 34, 34)
...
TextBox.FocusLost:Connect(function()
 ...
 pcall(callback, TextBox.Text)
        ...
        function main:Textbox(text, disappear, callback)
            ...
            txtbtn.Text = ""
            txtbtn.TextColor3 = Color3.fromRGB(34, 34, 34)
            txtbtn.TextSize = 14.000

            RealTextbox.Name = "RealTextbox"
            RealTextbox.Parent = Textbox
            RealTextbox.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
