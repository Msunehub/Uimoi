...
_G.Color = Color3.fromRGB(176, 245, 15)
...
UICornerFrame.Parent = TabFrame
        ...
        function Update:Notification(textdesc)
            ...
            OkayBtnTitle.TextColor3 = Color3.fromRGB(32, 32, 32)
            ...
            OkayBtn.MouseEnter:Connect(function()
                TweenService:Create(OkayBtn, TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                    BackgroundColor3 = Color3.fromRGB(32, 32, 32) }):Play()
            end)
        ...
        function main:Button(text, callback)
            ...
            TextBtn.Text = text
            TextBtn.TextColor3 = Color3.fromRGB(32, 32, 32)
            ...
            Black.Name = "Black"
            Black.Parent = Button
            Black.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
...
CheckFrame2.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
...
ImageButton.MouseButton1Click:Connect(function()
 ...
 pcall(callback, toggle)
        ...
        function main:Toggle(text, config, callback)
            ...
            Button.Text = ""
            Button.TextColor3 = Color3.fromRGB(32, 32, 32)
            ...
            ToggleImage.BackgroundColor3 = Color3.fromRGB(112, 112, 115)
            ...
            Button.MouseButton1Click:Connect(function()
                if toggled == false then
                    ...
                    TweenService:Create(
                        Circle,
                        TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                        { BackgroundColor3 = Color3.fromRGB(91, 128, 43) }
                    ):Play()
                end
...
Title.TextXAlignment = Enum.TextXAlignment.Left
        ...
        function main:Dropdown(text, option, callback)
            ...
            DropButton.Text = ""
            DropButton.TextColor3 = Color3.fromRGB(32, 32, 32)
        ...
        function main:Slider(text, min, max, start, callback)
            ...
            SliderFrame_2.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
...
AHEHE.Text = ""
AHEHE.TextColor3 = Color3.fromRGB(32, 32, 32)
...
TextBox.FocusLost:Connect(function()
 ...
 pcall(callback, TextBox.Text)
        ...
        function main:Textbox(text, disappear, callback)
            ...
            txtbtn.Text = ""
            txtbtn.TextColor3 = Color3.fromRGB(32, 32, 32)
            txtbtn.TextSize = 14.000

            RealTextbox.Name = "RealTextbox"
            RealTextbox.Parent = Textbox
            RealTextbox.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
